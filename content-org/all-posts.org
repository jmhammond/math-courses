...
:END:
This week, be sure to read and watch each of these sections and work
...
- Required: Do all the exercises at the bottom of each section, check
  ...
  you're unsure!
- (optional): Practice additional exercises in the supplemental textbooks if you need/want: [[http://discrete.openmathbooks.org/dmoi3/][DMOI]] and [[http://faculty.uml.edu/klevasseur/ads/index-ads.html][Applied Discrete Structures]]. (Right click to open in new window)
...
- *REMEMBER* ! [[https://discourse.math.wichita.edu/t/sample-checkpoint-1-and-solutions/1108][A sample checkpoint is available]]! (Right click to open in new window)
  I highly recommend you practice it as you're studying to get some experience.
- For more information about uploading, [[https://discourse.math.wichita.edu/t/uploading-weekly-checkpoints-to-nextcloud/1113][see here]]. (Right click to open in new window)
...
[[https://youtu.be/cjoz2SwNo70][More information about where to find grades is in a video here]]. (right click to open in new tab)
...
through the homework! *
[[https://www.math.wichita.edu/~hammond/class-notes/section-numtheory-encryption.html][Application:
Encryption]] * Additional topics in ciphers TBD
...
This week, be sure to read and watch each of these sections and work
through the homework! *
[[https://www.math.wichita.edu/discrete-book/section-counting-basics.html][Multiplicative
and Addititive Principles]]
...
This week, be sure to read and watch each of these sections and work
through the homework! *
[[https://www.math.wichita.edu/discrete-book/section-counting-binomial.html][Binomial
Coefficients and combinatorial proof]]
...
This week, be sure to read and watch each of these sections and work
through the homework! *
[[https://www.math.wichita.edu/discrete-book/section-counting-fib.html][Counting
Fibonacci Numbers with combinatorial proof]]
